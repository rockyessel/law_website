          ...
          <div className='w-[400px]  bg-gray-50 flex flex-col items-center shadow-lg'>
            ...
            <div className='flex flex-col gap-4 w-full'>
              ...
              <p className='px-2 w-full text-center font-medium'>
                ...
                for entertainers and athletes. Marirose has worked for the NFL
                and has represented entertainers, record labels, and athletes.
              </p>
              <Link
                to='/contact'
                className='bg-yellow-800 text-white w-full text-center font-medium text-xl cursor-pointer px-2 py-1'
              >
          ...
          <div className='w-[400px]  bg-gray-50 flex flex-col items-center shadow-lg'>
            ...
            <div className='flex flex-col gap-4 w-full'>
              ...
              <p className='px-2 w-full text-center font-medium'>
                ...
                commercial, professional, employment, and personal dispute that
